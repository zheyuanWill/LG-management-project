  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">备件供应项目</h1>
          <p className="text-muted-foreground mt-1">管理备件供应项目,跟踪物流与签收</p>
        </div>
        <Button onClick={() => navigate({ to: '/projects/new', search: { type: 'spare_parts' } })} size="lg">
      ...
      {isLoading ? (
        ...
        <div className="py-16 text-center text-muted-foreground">
          ...
          <p className="text-lg">暂无备件供应项目</p>
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {filteredProjects.map((project) => (
            <Card
              ...
              onClick={() => navigate({ to: `/spare-parts/${project.id}` })}
            >
